...
blood_card_data = [
    ...
    ('Undead Cat', 'Cat_Undead', 3, 6, 1, 'common', 'nature', None),
    ('The Daus', 'Daus', 2, 2, 2, 'common', 'nature', None),
    ('Elk', 'Deer', 2, 4, 2, 'common', 'nature', None),
    ('Elk Fawn', 'Deercub', 1, 1, 1, 'common', 'nature', None),
    ...
    ('Vertabrae', None, 0, 1, 0, 'common', 'nature', None),
    ...
    ('Starvation_Flight', 'StarvingMan', None, None, 0, 'common', 'nature', None),
...
card_tribe_data = [
    ...
    ('Elk', 'Deer', 'Hooved', 'hooved'),
    ('Elk Fawn', 'DeerCub', 'Hooved', 'hooved'),
    ('Geck', 'Geck', 'Reptilian', 'reptile'),
    ('Black Goat', 'Goat', 'Hooved', 'hooved'),
    ('Black Goat', 'Goat_Sexy', 'Hooved', 'hooved'),
    ('Child 13', 'JerseyDevil', 'Hooved', 'hooved'),
    ('Child 13', 'JerseyDevil_Flying', 'Hooved', 'hooved'),
    ...
    ('Strange Larva', 'Mothman_1', 'Insectoid', 'insect'),
    ('Strange Pupa', 'Mothman_2', 'Insectoid', 'insect'),
    ('Mothman', 'Mothman_3', 'Insectoid', 'insect'),
    ...
    ('River Snapper', 'Turtle', 'Reptilian', 'reptile'),
    ...
    ('Mud Turtle', 'MudTurtle_Shelled', 'Reptilian', 'reptile'),
...
card_sigil_data = [
    ...
    ('Elk', 'Deer', 'Sprinter', 'strafe'),
    ('Elk Fawn', 'DeerCub', 'Sprinter', 'strafe'),
    ('Elk Fawn', 'DeerCub', 'Fledgling', 'evolve_1'),
    ('Field Mice', 'FieldMice', 'Fecundity', 'drawcopy'),
    ('Black Goat', 'Goat', 'Worthy Sacrifice', 'tripleblood'),
    ('Black Goat', 'Goat_Sexy', 'Worthy Sacrifice', 'tripleblood'),
    ('Child 13', 'JerseyDevil', 'Many Lives', 'sacrificial'),
    ('Child 13', 'JerseyDevil_Flying', 'Many Lives', 'sacrificial'),
    ('Child 13', 'JerseyDevil_Flying', 'Airborne', 'flying'),
    ...
    ('Strange Larva', 'Mothman_1', 'Fledgling', 'evolve_1'),
    ('Strange Pupa', 'Mothman_2', 'Fledgling', 'evolve_1'),
    ('Mothman', 'Mothman_3', 'Airborne', 'flying'),
    ...
    ('Starvation', 'StarvingMan', 'Repulsive', 'preventattack'),
    ('Starvation_Flight', 'StarvingMan', 'Repulsive', 'preventattack'),
    ('Starvation_Flight', 'StarvingMan', 'Airborne', 'flying'),
    ('Leaping Trap', 'Trap', 'Mighty Leap', 'reach'),
    ('Leaping Trap', 'Trap', 'Steel Trap', 'steeltrap'),
    ('Strange Frog', 'TrapFrog', 'Mighty Leap', 'reach'),
    ('Frozen Opossum', 'Frozen_Opossum', 'Frozen Away', 'icecube'),
    ...
    ('Mud Turtle', 'MudTurtle_Shelled', 'Armored', 'deathshield'),
...
card_flag_data = [
    ...
    ('Golden Pelt', 'Pelt_Golden', 'golden'),
    ('Golden Pelt', 'Pelt_Golden', 'emission'),
    ('Greater Smoke', 'Smoke_Improved', 'emission'),
    ('Starvation', 'StarvingMan', 'hide_power_and_health'),
    ('Starvation_Flight', 'StarvingMan', 'hide_power_and_health'),
