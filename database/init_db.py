...
blood_card_data = [
    ...
    ('Adder', 'Adder', 1, 1, 'blood_2', 'common', 'nature', None),
    ('Amalgam', 'Amalgam', 3, 3, 'blood_2', 'rare', 'nature', None),
    ('Worker Ant', 'Ant', None, 2, 'blood_1', 'common', 'nature', None),
    ('Ant Queen', 'AntQueen', None, 3, 'blood_2', 'common', 'nature', None),
    ('Beaver', 'Beaver', 1, 4, 'blood_2', 'common', 'nature', None),
    ('Bee', 'Bee', 1, 1, None, 'common', 'nature', None),
    ('Beehive', 'Beehive', 0, 2, 'blood_1', 'common', 'nature', None),
    ('Bloodhound', 'Bloodhound', 2, 3, 'blood_2', 'common', 'nature', None),
    ('Boulder', 'Boulder', 0, 5, None, 'terrain', 'nature', None),
    ('Bullfrog', 'Bullfrog', 1, 2, 'blood_1', 'common', 'nature', None),
    ('Caged Wolf', 'CagedWolf', 0, 6, 'blood_2', 'terrain', 'nature', None),
    ('Cat', 'Cat', 0, 1, 'blood_1', 'common', 'nature', None),
    ('Undead Cat', 'UndeadCat', 3, 6, 'blood_1', 'common', 'nature', None),
    ('The Daus', 'Daus', 2, 2, 'blood_2', 'rare', 'nature', None),
    ('Elk', 'Elk', 2, 4, 'blood_2', 'common', 'nature', None),
    ('Elk Fawn', 'ElkFawn', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Field Mice', 'FieldMice', 2, 2, 'blood_2', 'common', 'nature', None),
    ('Geck', 'Geck', 1, 1, None, 'rare', 'nature', None),
    ('Black Goat', 'Goat', 0, 1, 'blood_1', 'common', 'nature', None),
    ('Black Goat', 'Goat_Sexy', 0, 1, 'blood_1', 'common', 'nature', None),
    ('Grizzly', 'Grizzly', 4, 6, 'blood_3', 'common', 'nature', None),
    ('Child 13', 'JerseyDevil', 0, 1, 'blood_1', 'rare', 'nature', None),
    ('Child 13', 'JerseyDevil_Flying', 2, 1, 'blood_1', 'rare', 'nature', None),
    ('Kingfisher', 'Kingfisher', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Magpie', 'Magpie', 1, 1, 'blood_2', 'common', 'nature', None),
    ('Mantis', 'Mantis', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Mantis God', 'MantisGod', 1, 1, 'blood_1', 'rare', 'nature', None),
    ('Mole', 'Mole', 0, 4, 'blood_1', 'common', 'nature', None),
    ('Mole Man', 'MoleMan', 0, 6, 'blood_1', 'rare', 'nature', None),
    ('Mole Seaman', 'MoleSeaman', 1, 8, 'blood_1', 'rare', 'nature', None),
    ('Moose Buck', 'Moose', 3, 7, 'blood_3', 'common', 'nature', None),
    ('Strange Larva', 'Mothman_1', 0, 3, 'blood_1', 'rare', 'nature', None),
    ('Strange Pupa', 'Mothman_2', 0, 3, 'blood_1', 'rare', 'nature', None),
    ('Mothman', 'Mothman_3', 7, 3, 'blood_1', 'rare', 'nature', None),
    ('Pack Mule', 'Mule', 0, 5, None, 'common', 'nature', None),
    ('River Otter', 'Otter', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Ouroboros', 'Ouroboros', 1, 1, 'blood_2', 'rare', 'nature', None),
    ('Pack Rat', 'PackRat', 2, 2, 'blood_2', 'rare', 'nature', None),
    ('Porcupine', 'Porcupine', 1, 2, 'blood_1', 'common', 'nature', None),
    ('Pronghorn', 'Pronghorn', 1, 3, 'blood_2', 'common', 'nature', None),
    ('Rabbit', 'Rabbit', 0, 1, None, 'common', 'nature', None),
    ('Rat King', 'RatKing', 2, 1, 'blood_2', 'common', 'nature', None),
    ('Raven', 'Raven', 2, 3, 'blood_2', 'common', 'nature', None),
    ('Raven Egg', 'RavenEgg', 0, 2, 'blood_1', 'common', 'nature', None),
    ('Great White', 'Shark', 4, 2, 'blood_3', 'common', 'nature', None),
    ('Great White', 'Shark_Bloodless', 4, 2, 'blood_3', 'common', 'nature', None),
    ('Skink', 'Skink', 1, 2, 'blood_1', 'common', 'nature', None),
    ('Skunk', 'Skunk', 0, 3, 'blood_1', 'common', 'nature', None),
    ('River Snapper', 'Turtle', 1, 6, 'blood_2', 'common', 'nature', None),
    ('Sparrow', 'Sparrow', 1, 2, 'blood_1', 'common', 'nature', None),
    ('squid_bell', 'SquidBell', None, 3, 'blood_2', 'common', 'nature', None),
    ('squid_cards', 'SquidCards', None, 1, 'blood_1', 'common', 'nature', None),
    ('squid_mirror', 'SquidMirror', None, 3, 'blood_1', 'common', 'nature', None),
    ('Squirrel', 'Squirrel', 0, 1, None, 'common', 'nature', None),
    ('Stoat', 'Stoat_Talking', 1, 3, 'blood_1', 'common', 'nature', None),
    ('Stunted Wolf', 'Wolf_Talking', 2, 2, 'blood_1', 'common', 'nature', None),
    ...
    ('Urayuli', 'Urayuli', 7, 7, 'blood_4', 'rare', 'nature', None),
    ('Vertebrae', 'Vertebrae', 0, 1, None, 'common', 'nature', None),
    ('Warren', 'Warren', 0, 2, 'blood_1', 'common', 'nature', None),
    ('Wolf', 'Wolf', 3, 2, 'blood_2', 'common', 'nature', None),
    ('Wolf Cub', 'WolfCub', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Bait Bucket', 'BaitBucket', 0, 1, None, 'terrain', 'nature', None),
    ('Broken Egg', 'BrokenEgg', 0, 1, None, 'terrain', 'nature', None),
    ('Dam', 'Dam', 0, 2, None, 'terrain', 'nature', None),
    ('Chime', 'DausBell', 0, 1, None, 'terrain', 'nature', None),
    ('Gold Nugget', 'GoldNugget', 0, 2, None, 'terrain', 'nature', None),
    ('Golden Pelt', 'Pelt_Golden', 0, 3, None, 'terrain', 'nature', None),
    ('Rabbit Pelt', 'Pelt_Hare', 0, 1, None, 'terrain', 'nature', None),
    ('Wolf Pelt', 'Pelt_Wolf', 0, 2, None, 'terrain', 'nature', None),
    ('Ring Worm', 'RingWorm', 0, 1, 'blood_1', 'common', 'nature', None),
    ('Stoat', 'Stoat', 1, 2, 'blood_1', 'common', 'nature', None),
    ('The Smoke', 'Smoke', 0, 1, None, 'common', 'nature', None),
    ('Greater Smoke', 'Smoke_Improved', 1, 3, None, 'common', 'nature', None),
    ('Starvation', 'StarvingMan', None, None, None, 'common', 'nature', None),
    ('Starvation', 'StarvingMan_Flight', None, None, None, 'common', 'nature', None),
    ('Leaping Trap', 'Trap', 0, 1, None, 'terrain', 'nature', None),
    ('Strange Frog', 'TrapFrog', 1, 2, 'blood_1', 'terrain', 'nature', None),
    ('Frozen Opossum', 'Frozen_Opossum', 0, 5, None, 'terrain', 'nature', None),
    ('Snowy Fir', 'Tree_SnowCovered', 0, 4, None, 'terrain', 'nature', None),
    ('Grand Fir', 'Tree', 0, 3, None, 'terrain', 'nature', None),
    ('Hungry Child', 'Child', 0, 0, None, 'common', 'nature', None),
    ('Stump', 'Stump', 0, 3, None, 'terrain', 'nature', None),
    ('AquaSquirrel', 'AquaSquirrel', 0, 1, None, 'common', 'nature', None),
    ('Skeleton Crew', 'SkeletonPirate', 2, 1, None, 'common', 'nature', None),
    ('Zombie Parrot', 'SkeletonParrot', 2, 3, None, 'common', 'nature', None),
    ('Wild Bull', 'Bull', 3, 2, 'blood_2', 'common', 'nature', None),
    ('Cuckoo', 'Cuckoo', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Ijiraq', 'Ijiraq', 4, 1, None, 'common', 'nature', None),
    ('Flying Ant', 'AntFlying', None, 1, 'blood_1', 'common', 'nature', None),
    ('Mud Turtle', 'MudTurtle_Shelled', 2, 2, 'blood_2', 'common', 'nature', None),
    ('Mud Turtle', 'MudTurtle', 2, 2, 'blood_2', 'common', 'nature', None),
    ('Dire Wolf Pup', 'DireWolfCub', 1, 1, 'blood_2', 'common', 'nature', None),
    ('Dire Wolf', 'DireWolf', 2, 5, 'blood_3', 'common', 'nature', None),
    ('Raccoon', 'Raccoon', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Lammergeier', 'Lammergeier', None, 4, 'blood_3', 'common', 'nature', None),
    ('Red Hart', 'RedHart', None, 2, 'blood_2', 'common', 'nature', None),
    ('Tadpole', 'Tadpole', 0, 1, None, 'common', 'nature', None),
    ('Pelt Lice', 'Lice', 1, 1, 'blood_4', 'rare', 'nature', None),
    ('Hodag', 'Hodag', 1, 5, 'blood_2', 'rare', 'nature', None),
    ('Great Kraken', 'Kraken', 1, 1, 'blood_1', 'rare', 'nature', None),
    ('Louis', 'Louis', 1, 1, 'blood_1', 'common', 'nature', None),
    ('Kaycee', 'Kaycee', 1, 2, 'blood_1', 'common', 'nature', None),
    # Bone Cards (Base Game)
    ('Alpha', 'Alpha', 1, 2, 'bone_4', 'common', 'nature', None),
    ('Amoeba', 'Amoeba', 1, 2, 'bone_2', 'rare', 'nature', None),
    ('Bat', 'Bat', 2, 1, 'bone_4', 'common', 'nature', None),
    ('Cockroach', 'Cockroach', 1, 1, 'bone_4', 'common', 'nature', None),
    ('Coyote', 'Coyote', 2, 1, 'bone_4', 'common', 'nature', None),
    ('Corpse Maggots', 'Maggots', 1, 2, 'bone_5', 'common', 'nature', None),
    ('Opossum', 'Opossum', 1, 1, 'bone_2', 'common', 'nature', None),
    ('Rattler', 'Rattler', 3, 1, 'bone_6', 'common', 'nature', None),
    ('Long Elk', 'LongElk', 1, 2, 'bone_4', 'rare', 'nature', None),
    ('Stinkbug', 'Stinkbug_Talking', 1, 2, 'bone_2', 'common', 'nature', None),
    ('Turkey Vulture', 'Vulture', 3, 3, 'bone_8', 'common', 'nature', None),
    ('Mealworm', 'MealWorm', 0, 2, 'bone_2', 'common', 'nature', None),
    ('Wolverine', 'Wolverine', 1, 3, 'bone_5', 'common', 'nature', None),
    ('Curious Egg', 'HydraEgg', 0, 1, 'bone_1', 'rare', 'nature', None),
